	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<div class="container">
			<div class="left">
				...
				<input type="file" name="fileupload" accept=".jpg" required>

				<label>Mobile:</label>
				<input type="number" pattern="[0-9]{10}" title="Please enter a 10-digit mobile number" name="num" autocomplete="off" required><br><br>
			</div>
			<div class="right">
				<label>Name:</label>
			...
			<div class="right">
				...
				<input type="password" name="pass" value="<?php echo $newroll; ?>" required>
