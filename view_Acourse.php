...
<body>
  <div class="navbar">
    ...
    <ul>
      ...
      <?php
        $con = mysqli_connect("localhost", "root", "", "cms"); // Replace with your actual database details
        if (!$con) {
          die(mysqli_error());
        }
  ...
  <?php
      if (isset($_GET['course_name'])) {
        ...
        echo '<h2 class="center">Students Marks of the Selected Course: '.$selectedCourseName.'</h2>';
