...
if (isset($_POST['submit'])) {
    ...
    $getCurrentDetailsQuery = "SELECT * FROM staff WHERE id='$staffId'";
    ...
    if ($currentDetailsResult) {
        ...
        if (
            ...
            echo "<script>window.location.href = 'update_staf_prof.php';</script>";
            exit();
        }
    }

    // Update the student details in the database
    $updateQuery = "UPDATE staff SET name='$name', email='$email',qual='$qual', phone='$phone', address='$address', pass='$pass' WHERE id='$staffId'";
    ...
    if ($result&&$res) {
        ...
        if (!empty($newImage)) {
            ...
            $deleteQuery = "SELECT image FROM staff WHERE id='$staffId'";
            ...
            $updateImageQuery = "UPDATE staff SET image='$targetFilePath' WHERE id='$staffId'";
        ...
        echo "<script>window.location.href = 'staff_prof.php';</script>";
        exit();
    } else {
