    ...
    <div class="content">
        ...
        <div class="dashboard">
            <div class="box">
                <h2></h2>
                <p>Add Marks</p>
                <button class="btn-view"><a href='mark_form.php'>Add</a></button>
            </div>
            <div class="box">
                <h2></h2>
                <p>View Marks</p>
                <button class="btn-view"><a href='view_Sfmark.php'>View</a></button>
            </div>
            <div class="box">
                <h2></h2>
                <p>Queries</p>
                <button class="btn-view"><a href='stf_qry_view.php'>View</a></button>
            </div>
        </div>
