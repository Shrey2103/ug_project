...
<body>
    ...
    <div class="navbar">
        <ul>
            ...
            <li><a href="student_dash.php">BACK</a></li>
        </ul>
    </div>
    ...
    <div class="content">
        <?php
            ...
            if (isset($_GET['course_type'])) {
                ...
                WHERE marks.course = '" . mysqli_real_escape_string($con, $department) . "' AND marks.type = '" . mysqli_real_escape_string($con, $selectedCourseType) . "' AND student.status = 'available'";
